---
title: 16|毕业答辩PPT的Latex版
date: 2018-02-08 20:59:13
tags: Latex
categories: 排版
---

毕设PPT带有学术的意味，会有很多公式和代码，这就很适合Latex编写。我修改了网上的一份南方科技大学的PPT，感觉还不错。具体代码在这里：Github。
...
```latex
\documentclass{beamer}  %设置为 Beamer 文档类型
...
\begin{frame}{Thank you}
\begin{center}
\Huge Thank you for listening!  %结束语
\end{center}
\end{frame}
\begin{frame}{Q\&A}
\begin{center}
